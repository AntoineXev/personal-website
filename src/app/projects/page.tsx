          ...
          >
            {projects.map((project) => (
                <Card as="li" key={project.name}>
                  ...
                  <p className="relative z-10 mt-6 flex text-sm font-medium text-zinc-400 transition group-hover:text-zinc-900 dark:text-zinc-200 dark:group-hover:text-zinc-100">
