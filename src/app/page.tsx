...
function Role ({role}: { role: Role }) {
    ...
    return (
        <li className="flex gap-4">
            <div
                className="relative mt-1 flex h-10 w-10 flex-none items-center justify-center rounded-full shadow-md shadow-zinc-800/5 ring-1 ring-zinc-900/5 dark:border dark:border-zinc-700/50 bg-zinc-800 dark:ring-0">
...
function Resume () {
    ...
    return (
        <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
            ...
            <Button href="https://www.linkedin.com/in/ahervet/details/experience/" variant="secondary"
                    className="group mt-6 w-full">
                See my full resume
                <ArrowDownIcon
                    className="h-4 w-4 stroke-zinc-400 transition group-active:stroke-zinc-600 dark:group-hover:stroke-zinc-50 dark:group-active:stroke-zinc-50 -rotate-90"/>
            </Button>
        </div>
    )
}
            ...
            <Container className="mt-9">
                <div className="max-w-2xl">
                    ...
                    <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
                        I’m Antoine, a software developer and entrepreneur based in Lyon. I’m the founder and CEO of <a
                        className="text-red-500" href="https://xev.agency">Xev.</a>, where we develop
